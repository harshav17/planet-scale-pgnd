...
func TestHandleGetExpenseGroups(t *testing.T) {
	t.Parallel()
...
func TestHandlePostExpenseGroup(t *testing.T) {
	t.Parallel()
...
func TestHandlePatchExpenseGroup(t *testing.T) {
	t.Parallel()
...
func TestHandleDeleteExpenseGroup(t *testing.T) {
	t.Parallel()
...
func TestHandleGetExpenseGroup(t *testing.T) {
	t.Parallel()
