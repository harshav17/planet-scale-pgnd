CREATE TABLE IF NOT EXISTS expense_participants (
    expense_id INT,
    user_id VARCHAR(255),
    amount_owed DECIMAL(10, 2),  -- The absolute amount the user owes for this expense
    share_percentage DECIMAL(5, 2),  -- The percentage of the total expense this user is responsible for
    split_method VARCHAR(50),  -- Indicates how the split was calculated (e.g., 'equal', 'uneven', 'by item', etc.)
